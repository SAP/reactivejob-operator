...
import (
	...
	batchcssapcom "github.com/sap/reactivejob-operator/pkg/client/informers/externalversions/batch.cs.sap.com"
...
type SharedInformerFactory interface {
	...
	Batch() batchcssapcom.Interface
}

func (f *sharedInformerFactory) Batch() batchcssapcom.Interface {
	return batchcssapcom.New(f, f.namespace, f.tweakListOptions)
}
